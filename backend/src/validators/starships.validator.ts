...
const validateFilms = [
    ...
    query("starship_class").optional().isString().notEmpty().withMessage("Queryparam 'starship_class' must be a string."),
    query("cost_in_credits").optional().isNumeric().withMessage("Queryparam 'cost_in_credits' must be a number."),
    query("MGLT").optional().isNumeric().withMessage("Queryparam 'MGLT' must be a number."),
    query("hyperdrive_rating").optional().isNumeric().withMessage("Queryparam 'hyperdrive_rating' must be a number."),
